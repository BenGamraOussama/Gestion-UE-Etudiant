...
// Issue a token (can be a random String persisted to a database or a JWTtoken)
// The issued token must be associated to a user
// Return the issued token
        // Use an HMAC secret for HS512
        String keyString = "change-this-secret-to-a-longer-random-value";
        Key key = new SecretKeySpec(keyString.getBytes(StandardCharsets.UTF_8), "HmacSHA512");
